CREATE TABLE IF NOT EXISTS cluster (guild_id BIGINT primary key, guild_name TEXT, master TEXT NOT NULL, version TEXT NOT NULL, UPDATE_PENDING BOOLEAN NOT NULL DEFAULT FALSE);
