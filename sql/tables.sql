...
INSERT INTO version (version) VALUES ('v3.7') ON CONFLICT (version) DO NOTHING;
...
CREATE TABLE IF NOT EXISTS nodes (guild_id BIGINT NOT NULL, node TEXT NOT NULL, last_seen TIMESTAMP DEFAULT NOW(), PRIMARY KEY (guild_id, node));
