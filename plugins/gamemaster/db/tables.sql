...
CREATE TABLE IF NOT EXISTS campaigns_servers (
    campaign_id INTEGER NOT NULL,
    server_name TEXT NOT NULL,
    PRIMARY KEY (campaign_id, server_name),
...
CREATE TABLE IF NOT EXISTS coalitions (
    ...
    coalition TEXT,
    coalition_join TIMESTAMP,
    coalition_leave TIMESTAMP,
    PRIMARY KEY(server_name, player_ucid),
...
CREATE TABLE IF NOT EXISTS messages (
    ...
    ack BOOLEAN NOT NULL DEFAULT TRUE,
