...
| /airbase warehouse     | airbase [category] [item] [value]         | all                   | \[DCS\], DCS Admin, GameMaster | Manage warehouses. Users with the DCS role can query the warehouses. DCS Admin and GameMaster can change it also.                                                                                                                  |
