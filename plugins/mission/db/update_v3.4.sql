CREATE TABLE IF NOT EXISTS bans_hist (ucid TEXT PRIMARY KEY, banned_by TEXT NOT NULL, reason TEXT, banned_at TIMESTAMP NOT NULL DEFAULT (now() AT TIME ZONE 'utc'), banned_until TIMESTAMP NOT NULL DEFAULT (now() AT TIME ZONE 'utc'), auto_unban BOOLEAN DEFAULT FALSE);
