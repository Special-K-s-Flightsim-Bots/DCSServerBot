INSERT INTO plugins (plugin, version) VALUES ('mission', 'v1.1') ON CONFLICT (plugin) DO NOTHING;
CREATE TABLE IF NOT EXISTS players (ucid TEXT PRIMARY KEY, discord_id BIGINT, name TEXT, last_seen TIMESTAMP);
